...
### 🌐 [NexOSS Ecosystem](https://www.nexoss.co/)
**Digital Evolution Architecture**

Building a connected ecosystem of intelligent platforms that solve problems across different sectors. Each platform is designed to revolutionize on a global scale.

`Scalable` `Multi-Tenant` `API-First`

</td>
<td width="50%">

### 🎯 [Nexein](https://nexein.com)
**The Intelligence Platform for Careers**

AI-powered career platform replacing the outdated job search system. Features unified job pipelines, dual CV scoring, and automated candidate matching.

`AI/ML` `Next.js` `Supabase`
